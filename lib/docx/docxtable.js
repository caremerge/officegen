...
module.exports = {
  ...
  _getBase: function (rowSpecs, colSpecs, opts) {
    ...
    var borders =  {};
    if(opts.borders) {
      var borderSize = opts.borderSize || "4";
      var borderColor = opts.borderColor || "000000";
      borders = {
        ...
        "w:insideH": { "@w:val":"single", "@w:sz": opts.bordersInsideH ? borderSize:0, "@w:space":"0", "@w:color": opts.bordersInsideH ? borderColor:'ffffff' },
        "w:insideV": { "@w:val":"single", "@w:sz":opts.bordersInsideV ? borderSize:0, "@w:space":"0", "@w:color": opts.bordersInsideV ? borderColor: 'ffffff' },
      }
    }
  ...
  _hasStrike: function(opts) {
    return !!(
      opts &&
      (opts.strike || opts.strikeThrough || opts.strikethrough)
    );
  },
  ...
  _getRow: function (cells, tblOpts, opts) {
    return {
      "w:tr": {
        "w:trPr": {
          "w:cantSplit": {
            '@w:val': opts && opts.cantSplit || tblOpts.cantSplitCell || 0
          },
          "w:trHeight": {
  ...
  _getCell: function(val, opts, tblOpts) {
    ...
    if(typeof val != 'string' && typeof val != 'number') {
      ...
      if (!this._hasStrike(opts)) {
        delete content[0]["w:p"]["w:r"]["w:rPr"]["w:strike"];
      }
    }
    var cellObj = {
      "w:tc": {
      ...
      if(cell.type === 'text' || cell.type === 'number') {
        ...
        if(cell.inline) {
          cell.values.forEach(function(row) {
            ...
            if(!_this._hasStrike(row.opts)) {
              delete tempRow["w:r"]["w:rPr"]["w:strike"];
            }
